...
try:
    ...
    try:
        import api_server
        create_layer_from_config = api_server.create_layer_from_config
        create_optimizer_from_config = api_server.create_optimizer_from_config
        create_loss_from_config = api_server.create_loss_from_config
    except:
        pytest.skip("No se puede importar api_server", allow_module_level=True)
