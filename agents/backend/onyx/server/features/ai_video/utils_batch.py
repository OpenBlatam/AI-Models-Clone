...
async def batch_fetch_status(uncached: List[str], use_onyx: bool, get_system, VIDEO_STATUS, cache, cache_key) -> Dict[str, Any]:
...
async def batch_fetch_logs(uncached: List[str], use_onyx: bool, get_system, VIDEO_LOGS, cache, cache_key) -> Dict[str, Any]:
