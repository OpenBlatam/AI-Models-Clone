...
class TestTrainingEndpoints:
    ...
    def test_quick_training_success(self, mock_training, auth_headers):
        response = client.post("/train/quick", json=valid_training_request, headers=auth_headers)
    ...
    def test_advanced_training_success(self, mock_training, auth_headers):
    ...
    def test_training_invalid_request(self, auth_headers):
    ...
    def test_config_training_success(self, mock_validate, mock_load_config, auth_headers):
    ...
    def test_config_training_file_not_found(self, auth_headers):
...
class TestExperimentEndpoints:
    def test_get_experiment_not_found(self, auth_headers):
        response = client.get("/experiments/nonexistent", headers=auth_headers)
        assert response.status_code == 404
    
    def test_list_experiments_empty(self, auth_headers):
    ...
    def test_get_experiment_success(self, auth_headers):
...
class TestInferenceEndpoints:
    def test_inference_success(self, auth_headers):
    ...
    def test_inference_invalid_request(self, auth_headers):
...
class TestBackgroundTasks:
    ...
    async def test_run_quick_training_success(self, mock_training):
    ...
    async def test_run_quick_training_failure(self, mock_training):
        from fastapi_app import run_quick_training, experiments
...
class TestErrorHandling:
    ...
    def test_internal_server_error(self, mock_training, auth_headers):
        response = client.post("/train/quick", json=valid_training_request, headers=auth_headers)
