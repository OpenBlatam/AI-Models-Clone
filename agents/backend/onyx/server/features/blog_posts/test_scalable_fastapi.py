...
@pytest.fixture
def test_cache_manager(test_settings):
    """Test cache manager."""
    return CacheManager(test_settings)


@pytest.fixture
def test_security_manager(test_settings):
...
@pytest.fixture
def sample_user(test_db_manager, test_security_manager, sample_user_data):
...
@pytest.fixture
def sample_token(test_security_manager, sample_user):
...
class TestDatabaseManager:
    ...
    def test_get_db(self, test_db_manager):
    ...
    @pytest.mark.asyncio
    async def test_get_async_db(self, test_db_manager):
    ...
    @pytest.mark.asyncio
    async def test_create_tables_async(self, test_db_manager):
...
class TestCacheManager:
    ...
    @pytest.mark.asyncio
    async def test_get_set_memory_only(self, test_cache_manager):
    ...
    @pytest.mark.asyncio
    async def test_delete(self, test_cache_manager):
        """Test cache deletion."""
        # Set value
    ...
    @pytest.mark.asyncio
    async def test_clear(self, test_cache_manager):
        """Test cache clearing."""
        # Set multiple values
    ...
    @pytest.mark.asyncio
    async def test_health_check(self, test_cache_manager):
...
class TestSecurityManager:
    ...
    def test_password_hashing(self, test_security_manager):
    ...
    def test_token_creation(self, test_security_manager):
        """Test token creation."""
    ...
    def test_token_verification(self, test_security_manager):
    ...
    def test_token_verification_invalid(self, test_security_manager):
        """Test invalid token verification."""
        # Test with invalid token
        token_data = test_security_manager.verify_token("invalid_token")
        assert token_data is None
    
    def test_encryption_decryption(self, test_security_manager):
    ...
    def test_api_key_generation(self, test_security_manager):
...
class TestRequestLoggingMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_request_logging(self, test_db_manager, test_metrics_manager):
...
class TestRateLimitingMiddleware:
    ...
    @pytest.mark.asyncio
    async def test_rate_limiting(self, test_cache_manager, test_settings):
...
class TestUtilityFunctions:
    ...
    @pytest.mark.asyncio
    async def test_external_api_call_success(self):
    ...
    @pytest.mark.asyncio
    async def test_external_api_call_failure(self):
...
class TestAPIRoutes:
    ...
    def test_register_user_duplicate(self, test_client, sample_user, sample_user_data):
    ...
    def test_login_success(self, test_client, sample_user, sample_user_data):
    ...
    def test_get_current_user_authenticated(self, test_client, sample_token):
    ...
    def test_update_current_user(self, test_client, sample_token):
    ...
    def test_external_data_endpoint(self, test_client):
    ...
    def test_create_background_task(self, test_client, sample_token):
...
class TestSecurity:
    ...
    def test_password_security(self, test_security_manager):
    ...
    def test_token_security(self, test_security_manager):
        """Test token security."""
        data = {"sub": "testuser", "user_id": 1}
    ...
    def test_encryption_security(self, test_security_manager):
