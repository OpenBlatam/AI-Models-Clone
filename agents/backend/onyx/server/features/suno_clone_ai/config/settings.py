...
class Settings(BaseSettings):
    ...
    max_audio_length: int = int(os.getenv("MAX_AUDIO_LENGTH", "300"))  # segundos
    ...
    # Generation settings
    default_duration: int = int(os.getenv("DEFAULT_DURATION", "30"))  # segundos
    ...
    dynamodb_endpoint_url: Optional[str] = os.getenv("DYNAMODB_ENDPOINT_URL")  # Para local testing
    
    # S3
    s3_bucket_name: Optional[str] = os.getenv("S3_BUCKET_NAME")
    s3_endpoint_url: Optional[str] = os.getenv("S3_ENDPOINT_URL")  # Para local testing
    ...
    # CloudWatch
    cloudwatch_log_group: Optional[str] = os.getenv("CLOUDWATCH_LOG_GROUP", "suno-clone-ai")
    ...
    lambda_timeout: int = int(os.getenv("LAMBDA_TIMEOUT", "900"))  # 15 minutos default
    ...
    service_mesh_type: str = os.getenv("SERVICE_MESH_TYPE", "istio")  # istio, consul, linkerd
    
    # API Gateway
    api_gateway_type: str = os.getenv("API_GATEWAY_TYPE", "aws")  # aws, kong, traefik
    ...
    response_cache_ttl: int = int(os.getenv("RESPONSE_CACHE_TTL", "300"))  # 5 minutos
    ...
    enable_jit: bool = os.getenv("ENABLE_JIT", "False").lower() == "true"  # JIT puede aumentar cold start
    ...
    event_bus_backend: str = os.getenv("EVENT_BUS_BACKEND", "memory")  # memory, redis, kafka, sqs
