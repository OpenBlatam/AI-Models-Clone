...
class StructuredLoggingMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app: ASGIApp, service_name: str = "blatam_service"):
        super().__init__(app)
...
class OpenTelemetryMiddleware:
    ...
    @staticmethod
    def setup_tracing(service_name: str = "blatam_service", 
...
def setup_advanced_middleware(app, service_name: str = "blatam_service", 
