...
class StreamWrapper(object):
    ...
    Converter instance.
    '''
    def __init__(self, wrapped, converter) -> Any:
...
class AnsiToWin32(object):
    ...
    def __init__(self, wrapped, convert=None, strip=None, autoreset=False) -> Any:
    ...
    def get_win32_calls(self) -> Optional[Dict[str, Any]]:
    ...
    def write_and_convert(self, text) -> Any:
        '''
    ...
    def write_plain_text(self, text, start, end) -> Any:
        if start < end:
    ...
    def extract_params(self, command, paramstring) -> Any:
        if command in 'Hf':
