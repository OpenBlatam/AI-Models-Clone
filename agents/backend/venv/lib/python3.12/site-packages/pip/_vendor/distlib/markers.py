...
def _is_version_marker(s) -> Any:
    return isinstance(s, string_types) and s in _VERSION_MARKERS


def _is_literal(o) -> Any:
    if not isinstance(o, string_types) or not o:
        return False
    return o[0] in '\'"'


def _get_versions(s) -> Optional[Dict[str, Any]]:
...
class Evaluator(object):
    ...
    def evaluate(self, expr, context) -> Any:
        """
...
def format_full_version(info) -> Any:
...
def interpret(marker, execution_context=None) -> Any:
    """
