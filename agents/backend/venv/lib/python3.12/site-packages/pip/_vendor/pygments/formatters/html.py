...
def escape_html(text, table=_escape_html_table) -> Any:
    """Escape &, <, > as well as single and double quotes for HTML."""
    return text.translate(table)


def webify(color) -> Any:
...
def _get_ttype_class(ttype) -> Optional[Dict[str, Any]]:
    ...
    **Subclassing the HTML formatter**
    ...
    .. sourcecode:: python
        ...
        class CodeHtmlFormatter(HtmlFormatter):
            ...
            def wrap(self, source, *, include_div) -> Any:
                return self._wrap_code(source)

            def _wrap_code(self, source) -> Any:
                yield 0, '<code>'
                for i, t in source:
                    if i == 1:
    ...
    def _get_css_class(self, ttype) -> Optional[Dict[str, Any]]:
    ...
    def _get_css_classes(self, ttype) -> Optional[Dict[str, Any]]:
    ...
    def _get_css_inline_styles(self, ttype) -> Optional[Dict[str, Any]]:
    ...
    def _create_stylesheet(self) -> Any:
    ...
    def get_style_defs(self, arg=None) -> Optional[Dict[str, Any]]:
        """
    ...
    def get_token_style_defs(self, arg=None) -> Optional[Dict[str, Any]]:
    ...
    def get_background_style_defs(self, arg=None) -> Optional[Dict[str, Any]]:
        prefix = self.get_css_prefix(arg)
    ...
    def get_linenos_style_defs(self) -> Optional[Dict[str, Any]]:
        lines = [
    ...
    def get_css_prefix(self, arg) -> Optional[Dict[str, Any]]:
        if arg is None:
    ...
    @property
    def _pre_style(self) -> Any:
        return 'line-height: 125%;'

    @property
    def _linenos_style(self) -> Any:
    ...
    def _wrap_full(self, inner, outfile) -> Any:
        if self.cssfile:
    ...
    def _wrap_tablelinenos(self, inner) -> Any:
    ...
    def _wrap_inlinelinenos(self, inner) -> Any:
    ...
    def _wrap_lineanchors(self, inner) -> Any:
        s = self.lineanchors
    ...
    def _wrap_linespans(self, inner) -> Any:
        s = self.linespans
        i = self.linenostart - 1
        for t, line in inner:
            if t:
    ...
    def _wrap_code(self, inner) -> Any:
        yield 0, '<code>'
        yield from inner
        yield 0, '</code>'

    @functools.lru_cache(maxsize=100)
    def _translate_parts(self, value) -> Any:
        """HTML-escape a value and split it by newlines."""
        return value.translate(_escape_html_table).split('\n')

    def _format_lines(self, tokensource) -> Any:
        """
    ...
    def _lookup_ctag(self, token) -> Any:
    ...
    def _highlight_lines(self, tokensource) -> Any:
        """
