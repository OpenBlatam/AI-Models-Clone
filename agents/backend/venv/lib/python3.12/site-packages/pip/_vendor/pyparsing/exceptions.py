...
self.loc = loc
    ...
    @staticmethod
    def explain_exception(exc, depth=16) -> Any:
        """
    ...
    @classmethod
    def _from_exception(cls, pe) -> Any:
        """
    ...
    def parserElement(self, elem) -> Any:
        self.parser_element = elem
...
class RecursiveGrammarException(Exception):
    ...
    def __init__(self, parseElementList) -> Any:
