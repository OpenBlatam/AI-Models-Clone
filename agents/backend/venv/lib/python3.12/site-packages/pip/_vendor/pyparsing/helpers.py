...
def counted_array(
    ...
    *,
    ...
    def count_field_parse_action(s, l, t) -> Any:
        nonlocal array_expr
        n = t[0]
...
def match_previous_literal(expr: ParserElement) -> ParserElement:
    ...
    def copy_token_to_repeater(s, l, t) -> Any:
        if t:
            if len(t) == 1:
                rep << t[0]
            else:
...
def match_previous_expr(expr: ParserElement) -> ParserElement:
    ...
    def copy_token_to_repeater(s, l, t) -> Any:
        ...
        def must_match_these_tokens(s, l, t) -> Any:
...
def replace_html_entity(s, l, t) -> Any:
...
def indentedBlock(blockStatementExpr, indentStack, indent=True, backup_stacks=[]) -> Any:
    """
