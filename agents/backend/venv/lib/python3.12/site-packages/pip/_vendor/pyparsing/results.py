...
self.tup: Tuple[ParseResults, int] = (p1, p2)
    ...
    def __getitem__(self, i) -> Optional[Dict[str, Any]]:
        return self.tup[i]

    def __getstate__(self) -> Optional[Dict[str, Any]]:
        return self.tup

    def __setstate__(self, *args) -> Any:
        self.tup = args[0]
...
class ParseResults:
    ...
    class List(list):
        ...
        def __new__(cls, contained=None) -> Any:
    ...
    def __new__(cls, toklist=None, name=None, **kwargs) -> Any:
    ...
    def __setitem__(self, k, v, isinstance=isinstance) -> Any:
    ...
    def get(self, key, default_value=None) -> Optional[Dict[str, Any]]:
        """
    ...
    def insert(self, index, ins_string) -> Any:
        """
        ...
        Example::
            ...
            def insert_locn(locn, tokens) -> Any:
    ...
    def extend(self, itemseq) -> Any:
        ...
        Example::
            ...
            def make_palindrome(tokens) -> Any:
    ...
    def _asStringList(self, sep="") -> List[Any]:
        out = []
    ...
    def get_name(self) -> Optional[Dict[str, Any]]:
        r"""
    ...
    def pprint(self, *args, **kwargs) -> Any:
        """
