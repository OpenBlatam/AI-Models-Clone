...
def _check_generic(cls, parameters, elen=_marker) -> Any:
...
if sys.version_info >= (3, 10):
    def _should_collect_from_parameters(t) -> Any:
        return isinstance(
...
def _collect_type_vars(types, typevar_types=None) -> Any:
...
# 3.7
    ...
    class _FinalForm(_ExtensionsSpecialForm, _root=True):
        def __getitem__(self, parameters) -> Optional[Dict[str, Any]]:
...
if sys.version_info >= (3, 10, 1):
    ...
    def _flatten_literal_params(parameters) -> Any:
    ...
    def _value_and_type_iter(params) -> Any:
        for p in params:
            yield p, type(p)
...
if hasattr(typing, "get_overloads"):  # 3.11+
    ...
    def get_overloads(func) -> Optional[Dict[str, Any]]:
...
def _get_protocol_attrs(cls) -> Optional[Dict[str, Any]]:
    attrs = set()
...
def _maybe_adjust_parameters(cls) -> Any:
...
if sys.version_info >= (3, 12):
    ...
    def _allow_reckless_class_checks(depth=3) -> Any:
    ...
    def _no_init(self, *args, **kwargs) -> Any:
    ...
    class _ProtocolMeta(_ProtocolMetaBase):
        ...
        def __subclasscheck__(cls, other) -> Any:
            if cls is Protocol:
    ...
    if sys.version_info >= (3, 8):
        ...
        class Protocol(metaclass=_ProtocolMeta):
            ...
            @typing._tp_cache
            def __class_getitem__(cls, params) -> Optional[Dict[str, Any]]:
...
def _ensure_subclassable(mro_entries) -> Any:
    def inner(func) -> Any:
...
if sys.version_info >= (3, 13):
    ...
    class _TypedDictMeta(type):
        def __new__(cls, name, bases, ns, total=True) -> Any:
    ...
    def TypedDict(__typename, __fields=_marker, *, total=True, **kwargs) -> Any:
...
if hasattr(typing, "assert_type"):
    ...
    def assert_type(__val, __typ) -> Any:
...
if hasattr(typing, "Required"):
    ...
    def get_type_hints(obj, globalns=None, localns=None, include_extras=False) -> Optional[Dict[str, Any]]:
...
# 3.7-3.8
    ...
    class _AnnotatedAlias(typing._GenericAlias, _root=True):
        ...
        """
        def __init__(self, origin, metadata) -> Any:
...
# 3.7-3.9
    ...
    def get_origin(tp) -> Optional[Dict[str, Any]]:
    ...
    def get_args(tp) -> Optional[Dict[str, Any]]:
...
# 3.9
    ...
    def TypeAlias(self, parameters) -> Any:
...
def _set_default(type_param, default) -> Any:
...
def _set_module(typevarlike) -> Any:
    # for pickling:
...
class TypeVar(metaclass=_TypeVarLikeMeta):
    ...
    def __new__(cls, name, *constraints, bound=None,
                ...
                default=_marker, infer_variance=False) -> Any:
...
if hasattr(typing, 'ParamSpec'):
    ...
    class ParamSpec(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *, bound=None,
                    covariant=False, contravariant=False,
                    infer_variance=False, default=_marker) -> Any:
            if hasattr(typing, "TypeAliasType"):
                # PEP 695 implemented, can pass infer_variance to typing.TypeVar
...
if not hasattr(typing, 'Concatenate'):
    ...
    class _ConcatenateGenericAlias(list):
        ...
        def __init__(self, origin, args) -> Any:
            super().__init__(args)
            self.__origin__ = origin
            self.__args__ = args
...
# 3.7-3.9
@typing._tp_cache
def _concatenate_getitem(self, parameters) -> Optional[Dict[str, Any]]:
    if parameters == ():
...
# 3.9
    ...
    @_ExtensionsSpecialForm
    def Concatenate(self, parameters) -> Any:
...
# 3.9
    ...
    @_ExtensionsSpecialForm
    def TypeGuard(self, parameters) -> Any:
...
class _SpecialForm(typing._Final, _root=True):
    ...
    def __init__(self, getitem) -> Any:
        self._getitem = getitem
        self._name = getitem.__name__
        self.__doc__ = getitem.__doc__

    def __getattr__(self, item) -> Optional[Dict[str, Any]]:
        if item in {'__name__', '__qualname__'}:
            return self._name

        raise AttributeError(item)

    def __mro_entries__(self, bases) -> Any:
...
if hasattr(typing, "LiteralString"):
    ...
    @_SpecialForm
    def LiteralString(self, params) -> Any:
...
if hasattr(typing, 'Required'):
    ...
    @_ExtensionsSpecialForm
    def Required(self, parameters) -> Any:
    ...
    @_ExtensionsSpecialForm
    def NotRequired(self, parameters) -> Any:
...
if sys.version_info >= (3, 12):  # PEP 692 changed the repr of Unpack[]
    ...
    @_UnpackSpecialForm
    def Unpack(self, parameters) -> Any:
        item = typing._type_check(parameters, f'{self._name} accepts only a single type.')
...
if hasattr(typing, "TypeVarTuple"):  # 3.11+
    ...
    class TypeVarTuple(metaclass=_TypeVarLikeMeta):
        ...
        def __new__(cls, name, *, default=_marker) -> Any:
            tvt = typing.TypeVarTuple(name)
            _set_default(tvt, default)
            _set_module(tvt)
            return tvt

        def __init_subclass__(self, *args, **kwds) -> Any:
...
self._shape: Tuple[*Ts] = shape
        ...
        def __init__(self, name, *, default=_marker) -> Any:
            self.__name__ = name
            _DefaultMixin.__init__(self, default)
...
if sys.version_info >= (3, 13):
    ...
    class _NamedTupleMeta(type):
        def __new__(cls, typename, bases, ns) -> Any:
    ...
    def _namedtuple_mro_entries(bases) -> Any:
        assert NamedTuple in bases
        return (_NamedTuple,)

    @_ensure_subclassable(_namedtuple_mro_entries)
    def NamedTuple(__typename, __fields=_marker, **kwargs) -> Any:
        ...
        if __fields is _marker:
            ...
            raise TypeError("Either list of fields or keywords"
                            " can be provided to NamedTuple, not both"f")
        if __fields is _marker or __fields is None:
            warnings.warn(
                deprecation_msg",
                DeprecationWarning,
...
if hasattr(_types, "get_original_bases"):
    ...
    def get_original_bases(__cls) -> Optional[Dict[str, Any]]:
