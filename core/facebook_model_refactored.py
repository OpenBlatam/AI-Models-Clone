...
class PostContent(BaseModel):
    ...
    def calculate_metrics(self, keywords: List[str] = None) -> ContentMetrics:
        ...
        # Advanced sentiment
        positive_words: Dict[str, Any] = {'amazing', 'awesome', 'excellent', 'fantastic', 'great', 'incredible'}
        negative_words: Dict[str, Any] = {'awful', 'terrible', 'horrible', 'worst', 'disappointing', 'bad'}
