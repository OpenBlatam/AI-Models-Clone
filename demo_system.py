...
class BlogPostDemo:
    ...
    async def demo_single_generation(self):
        ...
        spec = BlogSpec(
            topic="Inteligencia Artificial en el Marketing Digital 2025",
    ...
    async def demo_batch_generation(self):
        ...
        specs = [
            BlogSpec(
                topic="Automatización de Email Marketing con IA",
            ...
            BlogSpec(
                topic="El Futuro del Marketing Personalizado",
        ...
        for i, (spec, result) in enumerate(zip(specs, results), 1):
            status_icon = "✅" if result.status == GenerationStatus.COMPLETED else "❌"
    ...
    async def demo_content_analysis(self):
        ...
        keywords = ["inteligencia artificial", "marketing digital", "automatización", "IA"]
    ...
    async def demo_different_models(self):
        """Demo different AI models"""
        print("🤖 DEMO: Model Comparison")
        print("=" * 50)
        
        # Test topic
        topic = "Automatización de Procesos con IA"
    ...
    async def demo_export_formats(self):
        """Demo export formats"""
        ...
        spec = BlogSpec(
            topic="Tendencias de Marketing Digital 2025",
    ...
    async def _save_exports(self, result: BlogResult, prefix: str):
