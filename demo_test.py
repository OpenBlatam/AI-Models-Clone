...
def test_model():
    ...
    try:
        spec = ContentSpecification(
            ...
            primary_keywords=["AI", "innovation", "technology"]
        )
    ...
    try:
        post = FacebookPostFactory.create_from_specification(
            ...
            content_text="🚀 The AI revolution is here! Transform your business today. Ready?",
            hashtags=["AI", "innovation", "business", "future"]
        )
