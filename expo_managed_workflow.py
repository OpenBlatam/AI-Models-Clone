...
class ExpoManagedWorkflow:
    ...
    def initialize_project(self, project_name: str, template: str = "blank") -> bool:
    ...
    def build_development_build(self, platform: str) -> bool:
        ...
        try:
            ...
            cmd = ["npx", "expo", "run:ios" if platform == "ios" else "expo", "run:android"]
            result = subprocess.run(cmd, capture_output=True, text=True, cwd=self.project_path)
    ...
    def create_eas_build(self, platform: str, profile: str = "development") -> bool:
    ...
    def submit_to_store(self, platform: str, profile: str = "production") -> bool:
    ...
    def configure_updates(self, channel: str = "default") -> bool:
    ...
    def publish_update(self, message: str = "Update") -> bool:
