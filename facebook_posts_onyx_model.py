...
def create_demo_post() -> FacebookPostEntity:
    ...
    return FacebookPostFactory.create_from_specification(
        specification=spec,
        generation_config=config,
        content_text="🚀 AI is revolutionizing marketing! Discover how automation can 10x your results. Ready to transform your business?",
...
def demo_analysis() -> FacebookPostAnalysis:
    ...
    quality = QualityAssessment(
        ...
        trend_alignment=0.8,
        strengths=["Clear call-to-action", "Good emoji usage", "Relevant hashtags"],
        improvement_suggestions=["Add more specific benefits", "Include statistics"]
    )
