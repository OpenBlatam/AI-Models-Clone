...
class BlazeAIApplication:
    ...
    def _setup_middleware(self):
        ...
        # Ultra-fast speed middleware (first for maximum performance)
        if PERFORMANCE_AVAILABLE:
            self.app.add_middleware(SpeedMiddleware, enable_cache=True, cache_ttl=1.0)
            logger.info("✅ Ultra-fast speed middleware enabled")
