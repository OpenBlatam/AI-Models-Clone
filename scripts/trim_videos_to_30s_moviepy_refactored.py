"""
Script para recortar videos a 30 segundos usando MoviePy - Versión Refactorizada
=================================================================================
...
def main():
    ...
    logger.info("="*50)
    logger.info("Recortador de Videos a 30 segundos con MoviePy (Refactorizado)")
    logger.info("="*50)
    ...
    # Crear trimmer con MoviePy
    trimmer = VideoTrimmer(use_moviepy=True)
    
    if not trimmer.moviepy_available:
        logger.error("MoviePy no está disponible. Instálalo con: pip install moviepy")
        return
